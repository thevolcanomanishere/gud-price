...
for (const addr of Object.values(arbitrumDataFeeds)) feedChainMap[addr.toLowerCase()] = "arbitrum";
for (const addr of Object.values(baseDataFeeds)) feedChainMap[addr.toLowerCase()] = "base";
for (const addr of Object.values(ethereumDataFeeds)) feedChainMap[addr.toLowerCase()] = "ethereum";
for (const addr of Object.values(polygonDataFeeds)) feedChainMap[addr.toLowerCase()] = "polygon";
